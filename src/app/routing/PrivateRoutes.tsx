...
import MapboxCDNComponent from "../pages/GroundTransport/UserUI_G/map.tsx";
import Receipt from "../pages/GroundTransport/UserUI_G/recipt.tsx";
  ...
  return (
    <Routes>
      <Route element={<MasterLayout />}>
        ...
        <Route
          path="auth/*"
          element={<Navigate to="/Ground/Admindashboard" />}
        />
